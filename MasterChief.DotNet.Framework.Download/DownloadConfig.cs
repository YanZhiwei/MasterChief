...
namespace MasterChief.DotNet.Framework.Download
{
    ...
    public class DownloadConfig
    {
        ...
        public string FileNameEncryptorIvHexString { get; set; }

        /// <summary>
        ///     文件加密的Key，勿包括特殊字符
        /// </summary>
        [XmlAttribute("FileNameEncryptorKey")]
        public string FileNameEncryptorKey { get; set; }

        /// <summary>
        ///     限制的下载速度Kb
        /// </summary>
        [XmlAttribute("LimitDownloadSpeedKb")]
        public ulong LimitDownloadSpeedKb { get; set; }

        /// <summary>
        ///     文件下载的文件夹目录
        /// </summary>
        [XmlAttribute("DownLoadMainDirectory")]
        public string DownLoadMainDirectory { get; set; }
