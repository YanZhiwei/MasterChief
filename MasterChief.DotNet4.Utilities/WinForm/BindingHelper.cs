...
namespace MasterChief.DotNet4.Utilities.WinForm
{
    ...
    public static class BindingHelper
    {
        ...
        public static Binding SetBinding<C, T, P, D>(this C control, Expression<Func<C, P>> propertyPredicate, T dataSource, Expression<Func<T, D>> dataMemberPredicate, bool formattingEnabled = false, DataSourceUpdateMode updateMode = DataSourceUpdateMode.OnPropertyChanged)
            where C : Control
