namespace MasterChief.DotNet4.Utilities.Common
{
    ...
    public static class DictionaryHelper
    {
        ...
        public static Dictionary<TKey, TValue> AddRange<TKey, TValue>(this Dictionary<TKey, TValue> dict, IEnumerable<KeyValuePair<TKey, TValue>> dicList, bool replaceExisted)
        {
            foreach (KeyValuePair<TKey, TValue> item in dicList)
            {
